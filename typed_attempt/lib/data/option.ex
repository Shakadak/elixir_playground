...
defimpl Inspect, for: Data.Option do
  alias Data.Option
  require Option

  def inspect(Option.some(x), opts), do: Inspect.Algebra.concat(["Data.Option.some(", Inspect.Algebra.to_doc(x, opts), ")"])
  def inspect(Option.none(), _opts), do: Inspect.Algebra.concat(["Data.Result.none()"])
end
